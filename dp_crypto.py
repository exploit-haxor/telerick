...
def mode_brutekey():
    ...
    if found == '':
        ...
        versions = [
                    ...
                    '2017.3.913', '2018.1.117',
'2018.2.516', '2018.2.710',
                    '2018.3.910', '2019.1.115',
'2019.1.215', '2019.2.514',     
                    '2019.3.917', '2019.3.1023',
'2020.1.114', '2020.1.219',
                    '2020.2.512', '2020.2.617',
'2020.3.915', '2020.3.1021',
                    '2021.1.119'
                    ]
